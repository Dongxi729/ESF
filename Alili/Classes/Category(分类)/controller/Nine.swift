...
class Nine: UIViewController,LeftBtnViewDelegate,NineViewDelegate {
...
//        self.progressView.isHidden = true
    ...
    override func viewDidLoad() {
        ...
        if SH == 812 {
            leftRect = CGRect.init(x: 0, y: 0, width: UIScreen.main.bounds.width * 0.25, height: UIScreen.main.bounds.height - UIApplication.shared.statusBarFrame.height - (self.tabBarController?.tabBar.bounds.size.height)! * 1.5)
        } else {
            leftRect = CGRect.init(x: 0, y: 0, width: UIScreen.main.bounds.width * 0.25, height: UIScreen.main.bounds.height - UIApplication.shared.statusBarFrame.height - (self.tabBarController?.tabBar.bounds.size.height)! * 2)
        }
        
        self.tableView = UITableView.init(frame: leftRect)
